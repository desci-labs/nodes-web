...
const PaneHelp = () => {
  return (
    <div className="h-screen w-screen pl-14 fixed left-0 z-[102] flex flex-col text-white">
      <div
        className={`flex justify-center items-center pt-20 overflow-auto flex-col w-full h-[calc(100vh)] p-10 bg-neutrals-black top-0 z-[50] gap-3`}
      >
